...
function Scene_Credits() {
    ...
    var createdByText = new PIXI.Text(textStrings["createdBy"], {
        font: DiviceScreenwidth * 64 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "left"
    });
    ...
    var authorText = new PIXI.Text(textStrings["NickyCase"], {
        font: DiviceScreenwidth * 86 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "left"
    });
    ...
    var playtestersText = new PIXI.Text(textStrings["manyThanks"], {
        font: DiviceScreenwidth * 44 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "right"
    });
    ...
    var supportersText1 = new PIXI.Text(textStrings["patreonSupporters"], {
        font: DiviceScreenwidth * 45 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "left"
    });
    ...
    var thankYouText = new PIXI.Text(textStrings["thankYouForPlaying"], {
        font: DiviceScreenwidth * 55 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "center"
    });
    ...
    var finallyText = new PIXI.Text(textStrings["lastButNotLeast"], {
        font: DiviceScreenwidth * 37 / 960 + "px Times",
        fill: "#FFFFFF",
        align: "left"
    });
